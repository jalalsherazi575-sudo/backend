		                        ...
		                        if ($checkrecord==0) {
	                               ...
	                               if ($filename!='' && $optionImage!='') {
                                    ...
                                    if ($filename!='' && $optionImage!='') {
                                       ...
                                       $deleteDB::select( DB::raw("update tblquestionalphabetsnumbers SET questionId=$id,optionName='".$questionImageText."',wordSequence=".$isCorrectAnswer.",pronounciationFile='".$filename."',optionName='".$optionImage."' where id=$key"));
