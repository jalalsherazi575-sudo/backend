...
<script>
    ...
    function check_plan_package_delete(pid,cid)
    {      

        if (pid!='' && cid!='' && confirm("Note: By deleting the selected subscription, all the related transaction data will be removed permanently. Are you sure you want to proceed with deleting this detail?")) {
            window.location.href = "{{URL::to('admin/')}}/customer/planpackage/deleteTransactionPackage/"+cid+"/"+pid;
        }
    }
...
<div class="main-content">
    <div class="page-header">
        ...
        <a href="{{URL::to('admin/customer/assignplanpackage')}}/{{$customer->id}}" class="btn btn-primary"><i class="icon-fa icon-fa-plus"></i>Assign Package</a>
        </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h6>{{$customer->name}} Of Plan Package</h6>
                    ...
                    <table id="users-datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                               ...
                               <a onclick="return check_plan_package_delete({{$detail->id}},{{$customer->id}});" class="btn btn-default btn-sm" data-token="{{csrf_token()}}" data-delete data-confirmation="notie"> <i class="icon-fa icon-fa-trash"></i> Delete Transaction</a>
