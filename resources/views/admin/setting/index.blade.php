...
function check_delete(id)
{
	...
	$.ajax({
        url: "{{URL::to('admin/')}}/bank/delete/"+id,
        type: "get",
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{URL::to('admin/setting/')}}">General Settings</a></li>
                
            </ol>
            <div class="page-actions">
            	@if(checkPermission(Auth::user()->id,'create',$currentMenuId))
                <a href="{{URL::to('admin/setting/add')}}" class="btn btn-primary"><i class="icon-fa icon-fa-plus"></i> New General Setting</a>
                @endif
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
					    <form method="post" action="{{ URL::to('admin/setting/deleteall')}}" name="form">
						...
						<table id="users-datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tr>
								...
								<a href="{{URL::to('admin/setting/edit/'.$vals['id'].'')}}" class="btn btn-default btn-sm"><i class="icon-fa icon-fa-search"></i>Edit</a>
								@endif
