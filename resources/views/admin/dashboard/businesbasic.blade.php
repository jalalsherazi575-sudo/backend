@extends('admin.layouts.layout-basic-business')

@section('content')
    <div class="main-content" id="dashboardPage">
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12">
                <center><div class="new_dashboard"><h4>Welcome {{Auth::guard('businessuser')->user()->companyName}}  <br> @if (Auth::user()->role=='admin') Administator @else User @endif</h4></div></center>
             </div>   
        </div>    
        <!--<div class="row">
