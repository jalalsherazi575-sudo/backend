                ...
                <div class="card-body">
                    <form id="questionform" enctype="multipart/form-data" method="post" action="@if(isset($questions)){{ URL::to('admin/questions/edit/'.$questions->questionId.'')}}@else{{ URL::to('admin/questions/add') }}@endif" name="questions" novalidate>
                        ...
                        <div class="form-group" id="ques_name" @if((isset($questions) && $questions->questionType!=5) || !isset($questions))  @else style="display:none;"  @endif>
                            ...
                            <input type="text" @if((isset($questions) && $questions->questionType!=5))  @else required="required" @endif class="form-control @error('questions') is-invalid @enderror" value="@if(isset($questions)){{$questions->question}}@endif" name="question" id="question">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" maxlength="300" class="form-control @error('description') is-invalid @enderror" rows="5" cols="5">@if(isset($questions)){{$questions->description}}@endif</textarea>
                                    ...
                                    <div id="optionid1">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 col-md-3 col-lg-3">
                                                <label>Text</label>
                                                <br>  
                                                <input type="text" style="width:90%;" name="questionImageText[{{$optlist->id}}]"  maxlength="1000"   id="text1" class="form-control" placeholder="Melon" value="{{$optlist->questionImageText}}">
                                            </div>
                                ...
                                <div id="optionid{{$k}}">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3 col-md-3 col-lg-3">
                                            <label>Text</label>
                                            <br>  
                                            <input type="text" style="width:90%;" name="questionImageText[{{$optlist->id}}]"  maxlength="1000"  id="text{{$k}}" class="form-control" placeholder="Melon" value="{{$optlist->questionImageText}}">
                                        </div>
                                        ...
                                        <div id="optionid1">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3 col-md-3 col-lg-3">
                                                    <label>Text</label>
                                                    <br>  
                                                    <input type="text" style="width:90%;" name="questionImageText[1]" @if(!isset($questions))  @endif maxlength="1000"   id="text1" class="form-control" placeholder="Melon" value="">
                                                </div>
