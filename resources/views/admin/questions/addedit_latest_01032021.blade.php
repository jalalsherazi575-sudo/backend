                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-sm-2 col-md-2 col-lg-2">
                                              ...
                                              <div class="col-sm-3 col-md-3 col-lg-3">
                                               ...
                                               <br>
                                               <div class="row">
                                                    <div style="margin-left:25px;margin-bottom:10px;"><a href="{{ URL::to('/')}}/questionAudioSelection/{{$questions->questionAudio}}" target="_blank">Audio File</a>
                                                ...
                                                <br>
                                                 <div class="row">
                                                      <div style="margin-left:25px;margin-bottom:10px;">
                                                        <a href="{{ URL::to('/')}}/questionAudioSelection/{{$questions->questionAudio}}" target="_blank">Audio File</a>
