...
function removeSelectionword(idvals,optionsId) {
  ...
  function addNewOptions() {
       ...
       $('#secondansweroptionslist').append('<div  id="optionid'+optioncount+'"><label>Option '+optioncount+'</label><div class="row"><div class="col-sm-3 col-md-3 col-lg-3"><label>Browse Image</label><br><input type="file" style="width:100%;"  name="questionImage['+optioncount+']"   id="questionImage'+optioncount+'" class="form-control" placeholder="Image '+optioncount+'"></div><div class="col-sm-3 col-md-3 col-lg-3"><label>Text</label><br>  <input type="text" style="width:80%;" name="questionImageText['+optioncount+']"  maxlength="30"  id="text'+optioncount+'" class="form-control" placeholder="Melon" value=""></div><div class="col-sm-2 col-md-2 col-lg-2"><label>Is Correct Answer</label><br><input type="radio" style="width:40%;" name="isCorrectAnswer['+optioncount+']"    id="isCorrectAnswer'+optioncount+'" class="form-control radioinstant" onclick="return checkRadio('+optioncount+');" value="1"></div><div class="col-sm-3 col-md-3 col-lg-3"><label>Upload Audio File</label><br><input type="file" style="width:100%;" name="questionAudio['+optioncount+']" id="questionAudio'+optioncount+'" class="form-control"  placeholder="Question Audio File"></div><span onclick="return removeSelection('+optioncount+');" class="delete_btn">Delete</span></div></div>');
    ...
    if (optioncount >1) {
         ...
         $('#secondansweroptionslist').html('');
               ...
               for (var i=2;i<=optioncount;i++) {
                   ...
                   $('#secondansweroptionslist').append('<div  id="optionid'+i+'"><label>Option '+i+'</label><div class="row"><div class="col-sm-3 col-md-3 col-lg-3"><label>Browse Image</label><br><input type="file" style="width:100%;" name="questionImage['+i+']"    id="questionImage'+i+'" class="form-control" placeholder="Image '+i+'"></div><div class="col-sm-3 col-md-3 col-lg-3"><label>Text</label><br>  <input type="text" style="width:80%;" name="questionImageText['+i+']"  maxlength="30"   id="text'+i+'" class="form-control" placeholder="Melon" value=""></div><div class="col-sm-2 col-md-2 col-lg-2"><label>Is Correct Answer</label><br><input type="radio" style="width:40%;" name="isCorrectAnswer['+i+']"    id="isCorrectAnswer'+i+'" class="form-control radioinstant" onclick="return checkRadio('+i+');" value="1"></div><div class="col-sm-3 col-md-3 col-lg-3"><label>Upload Audio File</label><br><input type="file" style="width:100%;" name="questionAudio['+optioncount+']" id="questionAudio'+optioncount+'" class="form-control"  placeholder="Question Audio File"></div><span onclick="return removeSelection('+i+');" class="delete_btn">Delete</span></div></div>');
...
function removeAudio(Id) {
    ...
    if (Id!='' && confirm("Are you sure want to delete this audio?")) {

         $.ajax({

                url: "{{URL::to('admin/')}}/questions/deleteAudioSelect/"+Id,
                type: "get",
                ...
                success: function(html) {
                  ...
                  if (html!='') {
                    ...
                    alert("You have successfully deleted Audio.");
                    window.location.reload();
...
function removeAudioFile(Id) {
    ...
    if (Id!='' && confirm("Are you sure want to delete this Question Audio?")) {

         $.ajax({

                url: "{{URL::to('admin/')}}/questions/deleteAudio/"+Id,
                type: "get",
                ...
                success: function(html) {
                  ...
                  if (html!='') {
                    ...
                    alert("You have successfully deleted Question Audio.");
                    window.location.reload();
        ...
        <div class="card center">
            ...
            <div class="card-body">
                <form id="validateForm" enctype="multipart/form-data" method="post" action="@if(isset($questions)){{ URL::to('admin/questions/edit/'.$questions->questionId.'')}}@else{{ URL::to('admin/questions/add') }}@endif" name="questions" novalidate>
                    ...
                    <div class="form-group" id="questionheader"  @if((isset($questions) && $questions->questionType!=4) || !isset($questions)) style="display:none;" @endif>
                         <label>Question Header</label>
                         <input type="text" maxlength="100" class="form-control" value="@if(isset($questions)){{$questions->questionHeader}}@endif" name="questionHeader" id="questionHeaderText">
                    </div>
                    ...
                    <div class="form-group" id="createvideos"  @if((isset($questions) && $questions->questionType!=7) || !isset($questions)) style="display:none;" @endif>
                         <label>Upload Video</label>
                            ...
                            @if (isset($questions) && $questions->video!='')
                             ...
                             <span><strong>Note:</strong> Preferable file format (.MP4, .MOV, .WMV, .AVI) </span>
                    </div>  

                    <div class="form-group" id="createaudio"  @if((isset($questions) && $questions->questionType!=4) || !isset($questions)) style="display:none;" @endif>
                         <label>Upload Audio</label>
                            <input type="file" style="width:60%;" name="audio"  id="audio" class="form-control" placeholder="sample.mp3">
                            @if (isset($questions) && $questions->audio!='')
                             
                             <div class="row">
                                  <div style="margin-left:25px;margin-bottom:10px;margin-top:10px;"> 
                                    <a href="{{ URL::to('/')}}/questionAudios/{{$questions->audio}}" target="_blank">Audio File</a>
                                    
                                    <br><input type="button" name="removeAudio" style="margin-top:5px;" id="remove" value="Remove Audio" onclick="removeAudioFile({{$questions->questionId}});" class="btn btn-primary" >
                                  </div>
                                  
                             </div>
                             @endif

                             <span><strong>Note:</strong> Preferable file format (.MP3) </span>
                    </div>       
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-sm-2 col-md-2 col-lg-2">
                                              ...
                                              <div class="col-sm-3 col-md-3 col-lg-3">
                                                ...
                                                <br>  
                                                <input type="file" style="width:100%;" name="questionAudio[{{$optlist->id}}]"   id="questionAudio" class="form-control" placeholder="Question Audio">
                                                
                                                @if ($optlist->questionAudio!='')
                                               <br>
                                               <div class="row">
                                                    <div style="margin-left:25px;margin-bottom:10px;"><a href="{{ URL::to('/')}}/questionAudioSelection/{{$optlist->questionAudio}}" target="_blank">Audio File</a>
                                                      
                                                      <br><input type="button" name="removeProof" id="remove" value="Remove Audio" onclick="removeAudio({{$optlist->id}});" class="btn btn-primary" >
                                                    </div>
                                               </div>
                                               @endif
                                             </div>
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-sm-3 col-md-3 col-lg-3">
                                              ...
                                              <div class="col-sm-3 col-md-3 col-lg-3">
                                                ...
                                                <label>Browse Audio</label>
                                                <br>  
                                                <input type="file" style="width:100%;" name="questionAudio[{{$optlist->id}}]" @if ($optlist->questionAudio=='') required="required" @endif  id="questionAudio{{$k}}" class="form-control type1" placeholder="Image {{$k}}">

                                                @if ($optlist->questionAudio!='')
                                                <br>
                                                 <div class="row">
                                                      <div style="margin-left:25px;margin-bottom:10px;">
                                                        <a href="{{ URL::to('/')}}/questionAudioSelection/{{$optlist->questionAudio}}" target="_blank">Audio File</a>
                               ...
                               <label>Option 1</label>  
                                    <div class="row">
                                      ...
                                      <div class="col-sm-3 col-md-3 col-lg-3">
                                        <label>Browse Audio</label>
                                        <br>  
                                        <input type="file" style="width:100%;" name="questionAudio[1]" id="questionAudio" class="form-control" placeholder="Question Audio">
                                      </div>
